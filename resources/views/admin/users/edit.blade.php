...
<div class="page-shell">
    ...
    <div class="hero-banner animate-card">
        <div class="hero-content">
            <span class="hero-badge"><span class="dot"></span> Edit Account</span>
            <h1 class="hero-title">Edit User Profile</h1>
            <p class="hero-subtitle">Update access level and account details for this user.</p>
        </div>
    ...
    <form action="{{ route('admin.users.update', encrypt($user->id)) }}" method="POST" class="form-card animate-card">
        @csrf
        @method('PUT')
        ...
        <div class="form-footer animate-item-3">
            ...
            <button type="submit" class="btn-save px-10 py-3.5 bg-blue-600 text-white font-extrabold rounded-xl shadow-md flex items-center justify-center gap-2 tracking-wide">
