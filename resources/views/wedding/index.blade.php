...
<head>
    ...
    <style>
        ...
        * { -webkit-tap-highlight-color: transparent; box-sizing: border-box; }
        ...
        /* កាតកញ្ចក់ Responsive (បែងចែក Mobile & PC) */
        .glass-card {
            ...
            overflow: hidden;
            display: flex;
            flex-direction: column; /* សម្រាប់ Mobile ត្រួតគ្នាលើក្រោម */
        }
        
        @media (min-width: 768px) {
            .glass-card {
                flex-direction: row; /* សម្រាប់ Computer បែងចែកឆ្វេងស្ដាំ */
                border-radius: 2rem;
            }
        }
        ...
        @media (min-width: 768px) {
            .hero-image-container {
                width: 45%;
                height: auto; /* អោយរូបថតលាតពេញកម្ពស់នៅលើកុំព្យូទ័រ */
                min-height: 100%;
            }
        }
...
<body>
    ...
    <div class="relative z-10 w-full max-w-md md:max-w-4xl animate-item fade-up">
        ...
        <div class="glass-card">
            ...
            <div class="hero-image-container">
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-[rgba(127,29,29,0.3)] to-transparent md:bg-gradient-to-r"></div>
            </div>

            <div class="flex-1 p-6 md:p-10 w-full">
                
                <div class="text-center mb-8 fade-up delay-1">
                    <p class="text-xs uppercase tracking-[0.2em] text-[var(--color-gold)] font-bold mb-2">សូមគោរពអញ្ជើញ</p>
                    <h1 class="font-khmer-title text-3xl md:text-4xl mb-4 red-gradient-text">អាពាហ៍ពិពាហ៍</h1>
                    
                    <div class="flex items-center justify-center gap-3 md:gap-4 text-[#7f1d1d]">
                        <span class="font-khmer-title text-lg md:text-xl">ឡុន ពេជ្រ</span>
                        <span class="font-amp text-[var(--color-gold)] text-2xl md:text-3xl">&</span>
                        <span class="font-khmer-title text-lg md:text-xl">ជួប សុខធីតា</span>
                    </div>
                </div>

                <div class="space-y-3 mb-8 fade-up delay-2">
                ...
                <div class="pt-6 border-t border-gray-100 fade-up delay-2">
                    <h3 class="text-center font-bold text-[#7f1d1d] text-lg mb-5">បញ្ជាក់ការចូលរួម (RSVP)</h3>

                    <form id="rsvpForm" action="{{ route('wedding.rsvp') }}" method="POST" class="space-y-4">
                        @csrf

                        <div>
                            <label for="guest_name" class="field-label">ឈ្មោះរបស់អ្នក</label>
                            <input id="guest_name" type="text" name="guest_name" placeholder="ឧ. សុខ វាសនា..." class="w-full px-4 py-3 modern-input rounded-xl" required autocomplete="name">
                        </div>

                        <fieldset class="pt-2">
                            <legend class="field-label mb-2">ចំនួនអ្នកចូលរួម</legend>
                            <div class="grid gap-3">
                                <label class="block relative">
                                    ...
                                    <div class="pax-card">
                                        ...
                                        <span class="font-bold text-[#3f1818] text-sm md:text-base">ចូលរួមម្នាក់ឯង</span>
                                    </div>
                                </label>
                                ...
                                <label class="block relative">
                                    ...
                                    <div class="pax-card">
                                        ...
                                        <span class="font-bold text-[#3f1818] text-sm md:text-base">ចូលរួម ២ នាក់</span>
                                    </div>
                                </label>
                                ...
                                <label class="block relative">
                                    ...
                                    <div class="pax-card">
                                        ...
                                        <span class="font-bold text-[#3f1818] text-sm md:text-base">មិនអាចចូលរួមបានទេ</span>
                                    </div>
                                </label>
                            </div>
                        </fieldset>
